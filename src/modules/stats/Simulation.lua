...
local ClassType = require "@ClassType"
local ExperienceCalculation = require "@stats.ExperienceCalculation"
local ProficiencyPenalties = require "@stats.ProficiencyPenalties"
...
local Identification = require "@stats.Identification"

local Map = require "core.Map"
local GameObject = require "core.GameObject"
local GameState = require "core.GameState"
local PlayerObject = require "@objects.PlayerObject"
local MonsterObject = require "@objects.MonsterObject"
...
local function fight_spawn_if_over(GM)
    ...
    for monster,amount in pairs(fight) do
        ...
        for i=1,amount do
            ...
            local TTK = require "@simulation.TimeToKillCalculation"
